...
**Please note that these courses often favor our lowest-cost model, Claude Haiku 4.5, to keep API costs down for students following along with the materials. Feel free to use other Claude models if you prefer.**